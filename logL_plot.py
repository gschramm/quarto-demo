...
def plot_logL(axx, y1, y2, b1, b2, X1, X2, show_grad=False):
    ...
    if show_grad:
        ...
        axx.quiver(xhat_1, xhat_2, grad_x1, grad_x2, scale_units="width", scale=10.0)
...
x1 = np.linspace(-0.8, 3.0, 500)
x2 = np.linspace(-0.8, 3.0, 500)
X1, X2 = np.meshgrid(x1, x2)

# ── Case (i): y1=1, y2=3 — interior solution ─────────────────────────────────
